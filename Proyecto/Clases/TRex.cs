...
{
   public class TRex:Jugador, Retrocede
    {
       public string poder = "Mandar a algún jugador\n a la casilla de salida";
    ...
    //   SoundPlayer NOOOOOO = new SoundPlayer("Sonidos/voice-2016-05-14-17-51.wav");
       ...
       public Point punto;
       public bool Retrocediend;

       public bool murio = false;

       public TRex(Tablero t, Point p, Color c, Image d, string nombre, string fondo)
           : base(t, p, c, d, nombre)
       {
