...
namespace Proyecto.Clases
{
  public  class Pegaso:Jugador
    {
      public string poder = "Teletransportarte hasta el\npróximo tornado";
      public bool encontre = false;
      ...
      int yy;
      int x, y;
      public int nuevaX, nuevaY;
     public bool Retrocediend = false;
     public bool murio = false;
      public Pegaso(Tablero t, Point p, Color c, Image d, string nombre, string fondo)
          : base(t, p, c, d,nombre)
      {
          punto = p;
       xx  = punto.X;
      ...
      int po = 0;
      int po1 = 0;
      //Otro metodo mover quizas más sencillo
