   ...
   public class Fenix:Jugador
    {
      ...
      int yy;
      int x, y;
       public string poder = "Bajar la puntuación\na algún jugador en 1000 puntos";


     public  bool Retrocediend = false;
     public bool murio = false;
       public Fenix(Tablero t, Point p, Color c, Image d, string nombre, string fondo)
           : base(t, p, c, d, nombre)
       {
            punto = p;
       xx  = punto.X;
